...
public class RedStone extends LinearOpMode {
    ...
    public void runOpMode(){
        ...
        base.drivetrain.encoderDrive(DRIVE_SPEED, FourWheelMecanum.Direction.RIGHT, 28, 6);
        ...
        base.drivetrain.encoderDrive(DRIVE_SPEED, FourWheelMecanum.Direction.LEFT, 12, 5);
        ...
        base.drivetrain.encoderDrive(DRIVE_SPEED, FourWheelMecanum.Direction.RIGHT, 15, 6);
        ...
        //turns around
        base.drivetrain.encoderTurn(TURN_SPEED, Math.PI, 3);
