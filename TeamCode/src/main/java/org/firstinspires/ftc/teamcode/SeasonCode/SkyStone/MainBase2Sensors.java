...
public class MainBase2Sensors extends RobotBase {
    ...
    public MRRange rightRange;

    private RobotComponent[] components = new RobotComponent[4];

    public MainBase2Sensors(HardwareMap hardwareMap, Telemetry telemetry, LinearOpMode mode) {
    ...
    public void init() {
        ...
        rightRange = new MRRange(this, "rightRange");
        telemetry.addLine("Made right range");
        telemetry.update();
